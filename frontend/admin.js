...
async function adddata() {
    ...
    await fetch("https://tame-rose-lion-coat.cyclic.app/pro/add", {
        method: "POST",
        headers: {
...
const displaydata = async () => {
    ...
    await fetch("https://tame-rose-lion-coat.cyclic.app/pro/all", {
        headers: {
...
async function adm_delepro(element) {
    ...
    await fetch(`https://tame-rose-lion-coat.cyclic.app/pro/delete/${id}`, {
        method: "DELETE",
    }).then(result => {
        result.json();
        if (result.ok) {
